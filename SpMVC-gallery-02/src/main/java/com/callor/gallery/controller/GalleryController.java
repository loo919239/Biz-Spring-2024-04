...
public class GalleryController {
	...
	public String insert(Model model) {
		GalleryVO galleryVO = GalleryVO.builder().g_up_image("noimage.png").g_origin_image("noimage.png").build();
	 ...
	 * MultipartHttpServletRequest : form 의 input[type="file'] tag 에 담겨서 전달되는 여러개의
	 * 파일을 수신하는 객체 여기에는 절대 RequestParam() 을 붙여서는 안된다.
	 * 
	 */
