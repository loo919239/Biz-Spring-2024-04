...
@Service("authorProvuderImpl")
public class AuthorProvuderImpl implements AuthenticationProvider{
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		// 허가받은 사용자인가 확인하여 exception 을 발생하여 알려주기
		...
		user.put("email", "loo919239@naver.com");
