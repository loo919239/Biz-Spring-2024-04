		...
		<div class="w3-card-4 w3-dark-gray">
			<div class="w3-container w3-center">
				...
				<div class="w3-section">
					<input data-ccode="${PRODUCT.p_code}" type="button" value="수정" class="btn_update w3-button w3-green"/>
					<input data-ccode="${PRODUCT.p_code}" type="button" value="삭제" class="btn_delete w3-button w3-red"/>
				</div>
			</div>
		</div>
