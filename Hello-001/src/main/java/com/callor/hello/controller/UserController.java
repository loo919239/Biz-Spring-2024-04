 ...
 * Spring class 에서 @Controller 를 부착하면 이 클래스가 Routing 을 수행하게 된다
...
public class UserController {
	...
	/*
	 * 생성자에 아무 준비가 되지 않은 매게변수를 선언하는 것
	 * Spring 아
	 * 미리 준비되어 있는 userService bean 을 나에게 달라
	 * 나에게 객체를 주입해 달라(Dependency Injection, 의존성 주입)
	 */
