...
public class UserServiceImpl implements UserService {
	...
	/*
	 * Controllder 에서 Dao 통하여 User 정보를 조회할수 도 있다
	 ...
	 * UserService 에 method 하나를 생성하고 사용하는 것이
	 * 메모리 관리 측면에서 다소 유리하다
	 * userDao.findById(username) method 를 호출하고 return 값을
