...
public class MyBatisContextConfig {
	...
	public SqlSessionFactoryBean sessionFactoryBean() {
		...
		bean.setTypeAliasesPackage("com.callor.gallerty.model");
		Resource resource = context.getResource("classpath:/**/mapper/*-mpaeer.xml");
...
//		}
	...
	public PlatformTransactionManager transactionManager() {
		...
		/*
		 * manager 객체는 Platfor...Manager 인터페이스ㅡㄹ 사용하여 선언하였다.
		 * 이 인터페이스는 다양한 Rransaction 을 실행하기 위한 설계도 이다.
		 * DataSource...Manaver 는 Platfor...Manager 인터페이스를 사용하여
		 * 구현된 구현체 클래스 이다.
		 ...
		 * 결국 Platfor... 에는 없지만, DataSou...Manager 에만 있는 
